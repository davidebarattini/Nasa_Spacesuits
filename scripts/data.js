...
export const MAIN_POINTS = [
  ...
  // Main labels are shown one dot BEFORE the suit slide:
  // 1=Contesto, 3=Verso Gemini, 5=Verso Apollo, 7=Verso Shuttle
  { id: "mercury", label: "Mercury", slideIndex: 1 },
  { id: "gemini", label: "Gemini", slideIndex: 3 },
  { id: "apollo", label: "Apollo", slideIndex: 5 },
  { id: "shuttle", label: "Space shuttle", slideIndex: 7 },
];

/**
 * 10 slide totali:
 * - 5 main: 0,1,3,5,7
 * - 1 minor tra ogni main: (0->1) none, (1->3) 2, (3->5) 4, (5->7) 6
 * - 2 minor dopo l'ultimo main: (7) 8=EMU, 9=ACES
 */
export const slides = [
  {
    type: "intro",
    ...
    panels: {
      ...
      materiali: {
        ...
        inlineList: [
          ...
          "Nomex",
          "Neoprene / gomma pressurizzata",
          "Policarbonato (casco e visiera)",
        ],
        tabs: {
          informazioni: {
            list: [
              "Nylon ad alta resistenza: Tessuto esterno principale utilizzato per garantire robustezza, resistenza all’usura e protezione meccanica.",
              "Nomex: Materiale ignifugo impiegato per proteggere l’astronauta da alte temperature e rischio incendio durante lancio e rientro.",
              "Neoprene / gomma pressurizzata: Strati interni utilizzati per mantenere la pressione della tuta in caso di emergenza o depressurizzazione.",
              "Policarbonato (casco e visiera): Materiale trasparente ad alta resistenza agli urti e alla pressione, utilizzato per il casco ermetico.",
              "Poliuretani avanzati: Polimeri tecnici utilizzati in guarnizioni, giunti flessibili e componenti interni per garantire elasticità e tenuta.",
              "Metalli leggeri (alluminio / acciaio): Impiegati nei connettori, valvole e sistemi di collegamento per ossigeno e ventilazione.",
              "Materiali plastici rinforzati (tubi e circuiti): Utilizzati per il sistema di supporto vitale, permettono il passaggio sicuro di ossigeno e aria.",
            ],
          },
          immagini: [],
          video: [],
